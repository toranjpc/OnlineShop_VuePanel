...
useSeoMeta({ title: 'لیست فاکتور مرجوعی' })
...
<template>
  <FactorDataListPage
    page-path="/invoices/payment/list"
    title="لیست فاکتور مرجوعی"
    description="مشاهده فاکتورهای مرجوعی"
    api-url="invoices"
    :query-params="{ kind: 'return' }"
    search-placeholder="جستجو (شماره فاکتور)..."
    create-link="/invoices/payment/create"
    :columns="columns"
  />
</template>
